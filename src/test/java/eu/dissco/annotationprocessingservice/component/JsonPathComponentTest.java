...
class JsonPathComponentTest {
  ...
  void testGetAnnotationTargetPathsBadBatchMetadata()
    ...
    var batchMetadata = new BatchMetadata(
        1, "digitalSpecimenWrapper.occurrences[*].location.georeference.dwc:decimalLatitude", "11", AnnotationTargetType.DIGITAL_SPECIMEN);
  ...
  void testBadJsonpathFormat() throws JsonProcessingException {
    // Given
    var batchMetadata = new BatchMetadata(1, "[digitalSpecimenWrapper][occurrences][*][location][georeference]['dwc:decimalLatitude']['dwc:value']", "11", AnnotationTargetType.DIGITAL_SPECIMEN);
    var baseTargetClassSelector = new Target()
        .withOdsId(ID)
        .withOdsType(AnnotationTargetType.DIGITAL_SPECIMEN)
