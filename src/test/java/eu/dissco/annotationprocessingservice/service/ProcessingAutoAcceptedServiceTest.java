...
class ProcessingAutoAcceptedServiceTest {
  ...
  void testCreateAnnotation() throws Exception {
    ...
    given(annotationHasher.getAnnotationHashWithValue(any())).willReturn(ANNOTATION_HASH);
  ...
  void testCreateAnnotations() throws Exception {
    ...
    given(annotationHasher.getAnnotationHashWithValue(givenAutoAcceptedRequest().annotation())).willReturn(
        ANNOTATION_HASH);
    given(annotationHasher.getAnnotationHashWithValue(annotationRequests.get(1).annotation())).willReturn(
        ANNOTATION_HASH_2);
