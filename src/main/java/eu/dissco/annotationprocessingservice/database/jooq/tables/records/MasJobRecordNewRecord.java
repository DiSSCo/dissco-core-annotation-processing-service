...
public class MasJobRecordNewRecord extends UpdatableRecordImpl<MasJobRecordNewRecord> implements Record9<String, MjrJobState, String, Instant, Instant, JSONB, String, String, MjrTargetType> {
    ...
    /**
     * Setter for <code>public.mas_job_record_new.user_id</code>.
     */
    ...
    /**
     * Getter for <code>public.mas_job_record_new.user_id</code>.
     */
    ...
    /**
     * Setter for <code>public.mas_job_record_new.target_type</code>.
     */
    ...
    /**
     * Getter for <code>public.mas_job_record_new.target_type</code>.
     */
    ...
    @Override
    public Row9<String, MjrJobState, String, Instant, Instant, JSONB, String, String, MjrTargetType> valuesRow() {
    ...
    public Field<MjrTargetType> field9() {
        return MasJobRecordNew.MAS_JOB_RECORD_NEW.TARGET_TYPE;
    }
    ...
    @Override
    public MasJobRecordNewRecord value2(MjrJobState value) {
        setJobState(value);
        return this;
    }
    ...
    @Override
    public MasJobRecordNewRecord value9(MjrTargetType value) {
        setTargetType(value);
        return this;
    }

    @Override
    public MasJobRecordNewRecord values(String value1, MjrJobState value2, String value3, Instant value4, Instant value5, JSONB value6, String value7, String value8, MjrTargetType value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MasJobRecordNewRecord(String jobId, MjrJobState jobState, String masId, Instant timeStarted, Instant timeCompleted, JSONB annotations, String targetId, String userId, MjrTargetType targetType) {
        super(MasJobRecordNew.MAS_JOB_RECORD_NEW);
