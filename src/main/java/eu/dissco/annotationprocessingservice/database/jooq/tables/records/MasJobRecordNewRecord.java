...
public class MasJobRecordNewRecord extends UpdatableRecordImpl<MasJobRecordNewRecord> implements Record9<String, MasJobState, String, Instant, Instant, JSONB, String, String, String> {
    ...
    @Override
    public Row9<String, MasJobState, String, Instant, Instant, JSONB, String, String, String> fieldsRow() {
        return (Row9) super.fieldsRow();
    }

    @Override
    public Row9<String, MasJobState, String, Instant, Instant, JSONB, String, String, String> valuesRow() {
    ...
    @Override
    public MasJobRecordNewRecord value9(String value) {
        setTargetType(value);
        return this;
    }

    @Override
    public MasJobRecordNewRecord values(String value1, MasJobState value2, String value3, Instant value4, Instant value5, JSONB value6, String value7, String value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MasJobRecordNewRecord(String jobId, MasJobState jobState, String masId, Instant timeStarted, Instant timeCompleted, JSONB annotations, String targetId, String userId, String targetType) {
        super(MasJobRecordNew.MAS_JOB_RECORD_NEW);
