...
public class NewAnnotationRecord extends UpdatableRecordImpl<NewAnnotationRecord> implements Record16<String, Integer, String, String, String, String, JSONB, JSONB, Integer, String, Instant, String, JSONB, Instant, Instant, Instant> {
    ...
    /**
     * Setter for <code>public.new_annotation.deleted</code>.
     */
    ...
    /**
     * Getter for <code>public.new_annotation.deleted</code>.
     */
    ...
    @Override
    public Row16<String, Integer, String, String, String, String, JSONB, JSONB, Integer, String, Instant, String, JSONB, Instant, Instant, Instant> valuesRow() {
    ...
    public Field<Instant> field16() {
        return NewAnnotation.NEW_ANNOTATION.DELETED;
    }
    ...
    @Override
    public NewAnnotationRecord value16(Instant value) {
        setDeleted(value);
        return this;
    }

    @Override
    public NewAnnotationRecord values(String value1, Integer value2, String value3, String value4, String value5, String value6, JSONB value7, JSONB value8, Integer value9, String value10, Instant value11, String value12, JSONB value13, Instant value14, Instant value15, Instant value16) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NewAnnotationRecord(String id, Integer version, String type, String motivation, String targetId, String targetField, JSONB targetBody, JSONB body, Integer preferenceScore, String creator, Instant created, String generatorId, JSONB generatorBody, Instant generated, Instant lastChecked, Instant deleted) {
        super(NewAnnotation.NEW_ANNOTATION);
