...
public class Annotation extends TableImpl<AnnotationRecord> {
     ...
     */
    public final TableField<AnnotationRecord, AnnotationStatusEnum> ANNOTATION_STATUS = createField(DSL.name("annotation_status"), SQLDataType.VARCHAR.asEnumDataType(AnnotationStatusEnum.class), this, "");
