...
public class MasJobRecordRecord extends UpdatableRecordImpl<MasJobRecordRecord> implements Record10<String, MjrJobState, String, Instant, Instant, JSONB, String, String, MjrTargetType, JSONB> {
    ...
    /**
     * Setter for <code>public.mas_job_record.batch_metadata</code>. JSON
     * containing: inputField, inputValue, targetField. Null if no batching was
     * requested.
     */
    public void setBatchMetadata(JSONB value) {
        set(9, value);
    }

    /**
     * Getter for <code>public.mas_job_record.batch_metadata</code>. JSON
     * containing: inputField, inputValue, targetField. Null if no batching was
     * requested.
     */
    public JSONB getBatchMetadata() {
        return (JSONB) get(9);
    }
    ...
    @Override
    public Row10<String, MjrJobState, String, Instant, Instant, JSONB, String, String, MjrTargetType, JSONB> valuesRow() {
    ...
    public Field<JSONB> field10() {
        return MasJobRecord.MAS_JOB_RECORD.BATCH_METADATA;
    }
    ...
    @Override
    public MasJobRecordRecord value10(JSONB value) {
        setBatchMetadata(value);
        return this;
    }

    @Override
    public MasJobRecordRecord values(String value1, MjrJobState value2, String value3, Instant value4, Instant value5, JSONB value6, String value7, String value8, MjrTargetType value9, JSONB value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MasJobRecordRecord(String jobId, MjrJobState jobState, String masId, Instant timeStarted, Instant timeCompleted, JSONB annotations, String targetId, String userId, MjrTargetType targetType, JSONB batchMetadata) {
        super(MasJobRecord.MAS_JOB_RECORD);
