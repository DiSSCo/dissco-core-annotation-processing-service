...
public class MasJobRecordRecord extends UpdatableRecordImpl<MasJobRecordRecord> implements Record10<String, MjrJobState, String, Instant, Instant, JSONB, String, String, MjrTargetType, Boolean> {
    ...
    @Override
    public MasJobRecordRecord values(String value1, MjrJobState value2, String value3, Instant value4, Instant value5, JSONB value6, String value7, String value8, MjrTargetType value9, Boolean value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MasJobRecordRecord(String jobId, MjrJobState jobState, String masId, Instant timeStarted, Instant timeCompleted, JSONB annotations, String targetId, String userId, MjrTargetType targetType, Boolean batchingRequested) {
        super(MasJobRecord.MAS_JOB_RECORD);
