...
public class MasJobRecordRecord extends UpdatableRecordImpl<MasJobRecordRecord> implements Record12<String, MjrJobState, String, Instant, Instant, JSONB, String, String, MjrTargetType, Boolean, ErrorCode, Instant> {
    ...
    @Override
    public Row12<String, MjrJobState, String, Instant, Instant, JSONB, String, String, MjrTargetType, Boolean, ErrorCode, Instant> valuesRow() {
    ...
    @Override
    public MasJobRecordRecord values(String value1, MjrJobState value2, String value3, Instant value4, Instant value5, JSONB value6, String value7, String value8, MjrTargetType value9, Boolean value10, ErrorCode value11, Instant value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
