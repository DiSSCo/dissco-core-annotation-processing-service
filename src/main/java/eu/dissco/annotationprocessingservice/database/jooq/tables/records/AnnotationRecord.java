...
public class AnnotationRecord extends UpdatableRecordImpl<AnnotationRecord> {
     ...
     */
    public AnnotationRecord(String id, Integer version, String type, UUID annotationHash, String motivation, String mjrJobId, UUID batchId, String creator, Instant created, Instant modified, Instant lastChecked, Instant tombstoned, String targetId, JSONB data, AnnotationStatusEnum annotationStatus) {
        super(Annotation.ANNOTATION);
