...
public class AnnotationRecord extends UpdatableRecordImpl<AnnotationRecord> implements Record17<String, Integer, String, String, String, String, JSONB, JSONB, String, JSONB, Instant, JSONB, Instant, Instant, JSONB, Instant, UUID> {
    ...
    @Override
    public Row17<String, Integer, String, String, String, String, JSONB, JSONB, String, JSONB, Instant, JSONB, Instant, Instant, JSONB, Instant, UUID> valuesRow() {
    ...
    @Override
    public AnnotationRecord values(String value1, Integer value2, String value3, String value4, String value5, String value6, JSONB value7, JSONB value8, String value9, JSONB value10, Instant value11, JSONB value12, Instant value13, Instant value14, JSONB value15, Instant value16, UUID value17) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AnnotationRecord(String id, Integer version, String type, String motivation, String motivatedBy, String targetId, JSONB target, JSONB body, String creatorId, JSONB creator, Instant created, JSONB generator, Instant generated, Instant lastChecked, JSONB aggregateRating, Instant deletedOn, UUID annotationHash) {
        super(Annotation.ANNOTATION);
