...
public class AnnotationRecord extends UpdatableRecordImpl<AnnotationRecord> implements Record18<String, Integer, String, String, String, String, JSONB, JSONB, String, JSONB, Instant, JSONB, Instant, Instant, JSONB, Instant, UUID, String> {
    ...
    @Override
    public AnnotationRecord values(String value1, Integer value2, String value3, String value4, String value5, String value6, JSONB value7, JSONB value8, String value9, JSONB value10, Instant value11, JSONB value12, Instant value13, Instant value14, JSONB value15, Instant value16, UUID value17, String value18) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
