...
public class SourceSystemRecord extends UpdatableRecordImpl<SourceSystemRecord> {
     ...
     */
    public SourceSystemRecord(String id, String name, String endpoint, String description, Instant created, Instant deleted, String mappingId, Integer version, String creator, Object translatorType) {
        super(SourceSystem.SOURCE_SYSTEM);
